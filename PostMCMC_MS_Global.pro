...
pro iterative_PostMCMC_MS_Global;, dir_outputs, dir_inputs
   ...
   dosavfilesonly=0 ; Default, you do everything from sav file until synthese files and plots 
    ...
    ;dir_outputs=dir_os + '/home/obenomar/Pro/PSM_WP128_Sept2018/Raw_Results/TAMCMC-C-1.3.1.5beta/Data/Outputs/'
    ;dir_inputs=dir_os + '/home/obenomar/Pro/PSM_WP128_Sept2018/Data/Finalized-setups/Inputs/'
    ;dir_out=dir_os + '/home/obenomar/Pro/PSM_WP128_Sept2018/Level1/'
    ;modelname='model_Evolved_Global_a1etaa3_l1mixed'

    dir_outputs=dir_os + '/home/obenomar/Pro/PSM_WP128_Sept2018/Raw_Results/TAMCMC-C/Data/Outputs/'
    dir_inputs=dir_os + '/home/obenomar/Pro/PSM_WP128_Sept2018/Data/Finalized-setups/Inputs/'
    dir_out=dir_os + '/home/obenomar/Pro/PSM_WP128_Sept2018/Level1/'
    modelname='model_MS_Global_a1etaa3_HarveyLike'

    ;dir_outputs=dir_os + 'Level1-Outputs/RawMCMC_Outputs/Legacy_stars/psd/1011/'
    ;dir_inputs=dir_os + 'Level1-Outputs/MCMC_Inputs/Legacy_Kepler/psd/1011/'
    ;dir_out=dir_os + 'Temporary-Outputs/Level1/'
    ...
    keep_period=5. ; Keep 1 out of keep_period
